...
$installer->run("
  ...
  CREATE TABLE `{$installer->getTable('trsreports/product_tree_node')}` (
    `entity_id` INT(10) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    `product_id` INT(10) UNSIGNED NOT NULL,
    `parent_node_id` INT(10) UNSIGNED,
    ...
    FOREIGN KEY (parent_node_id)
      REFERENCES {$installer->getTable('trsreports/product_tree_node')}(entity_id)
      ON DELETE CASCADE,
    FOREIGN KEY (tree_id)
